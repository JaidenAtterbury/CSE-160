...
def classify(gc_content):
    ...
    # Calculate the GC Classification
    if gc_content > 0.55:
        classification = "high"
...
for base in nucleotides:
    ...
    # Compute G count for given file:
    if base == 'G':
        g_count += 1

    # Compute C count for given file:
    elif base == 'C':
        c_count += 1

    # Compute A count for given file:
    elif base == 'A':
        a_count += 1

    # Compute T count for given file:
    elif base == 'T':
        t_count += 1

# Compute the counts that will be presented in the output:
...
# Print out all of the findings/statistics:
